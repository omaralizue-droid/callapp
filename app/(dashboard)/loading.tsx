  ...
  return (
    <div className="space-y-6 text-xs animate-pulse select-none max-w-7xl mx-auto">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
        {[...Array(4)].map((_, idx) => (
          <div key={idx} className="bg-white border border-slate-200 p-5 rounded-xl shadow-sm space-y-3">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="lg:col-span-2 space-y-6">
          <div className="bg-white border border-slate-200 p-5 rounded-xl shadow-sm space-y-4">
            ...
            <div className="h-64 bg-slate-50 rounded-xl border border-slate-100 flex items-center justify-center">
